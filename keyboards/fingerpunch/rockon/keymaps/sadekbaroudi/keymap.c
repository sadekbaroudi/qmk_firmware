...
/*
 * The `LAYOUT_rockon_base` macro is a template to allow the use of identical
...
#define LAYOUT_rockon_base_wrapper(...)       LAYOUT_rockon_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_rockon_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_rockon_base_wrapper(
