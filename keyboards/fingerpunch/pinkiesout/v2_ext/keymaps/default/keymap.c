...
[_QWERTY] = LAYOUT_pinkiesout(
    ...
    KC_LCTL,   KC_LGUI,   KC_LALT,   KC_MINS,   LOWER,     KC_SPC,    KC_LALT,  _______,  _______,  KC_RALT,   KC_SPC,    RAISE,     KC_EQL,    KC_RALT,   KC_RGUI,   KC_RCTL
),
...
[_ADJUST] =  LAYOUT_pinkiesout(
    ...
    _______,       UG_TOGG,       UG_PREV,      UG_NEXT,       _______,       TG(_QWERTY),   _______,                      _______,       _______,       _______,       _______,       KC_F11,        KC_F12,        _______,
