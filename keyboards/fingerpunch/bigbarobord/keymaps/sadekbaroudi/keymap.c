...
/*
 * The `LAYOUT_bigbarobord_base` macro is a template to allow the use of identical
...
// clang-format off
#define LAYOUT_bigbarobord_base( \
...
#define LAYOUT_bigbarobord_base_wrapper(...)       LAYOUT_bigbarobord_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_bigbarobord_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_bigbarobord_base_wrapper(
    ...
    [_MOUSE] = LAYOUT_wrapper(
        ...
        __________________MOUSE_2__________________,          _______,         ___________________BLANK___________________,
...
static void render_logo_text(void) {
    oled_write_P(PSTR("bigbarobord"), false);
}
*/
