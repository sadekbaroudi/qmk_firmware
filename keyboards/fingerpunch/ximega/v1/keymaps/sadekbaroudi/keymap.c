...
#define LAYOUT_ximega_base_wrapper(...)       LAYOUT_ximega_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_ximega_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_ximega_base_wrapper(
