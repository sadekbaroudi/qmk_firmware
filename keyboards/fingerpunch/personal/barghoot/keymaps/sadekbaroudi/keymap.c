...
#define LAYOUT_barghoot_base_wrapper(...)       LAYOUT_barghoot_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_barghoot_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_barghoot_base_wrapper(
    ...
    [_NAVIGATION] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______, _______,                           KC_SPACE, KC_DOT, _______, _______, _______,
                                            _______, KC_TAB, _______, KC_BSPC, _______
    ),
    ...
    [_FUNCTION] = LAYOUT_wrapper(
        ...
        ___________________BLANK___________________,                            KC_SPACE, _______, _______, _______, _______,
                                            ___________________BLANK___________________
    ),
