...
#define LAYOUT_barobordhw_base_wrapper(...)       LAYOUT_barobordhw_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_barobordhw_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_barobordhw_base_wrapper(
