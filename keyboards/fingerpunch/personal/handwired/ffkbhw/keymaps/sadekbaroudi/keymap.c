...
/*
 * The `LAYOUT_ffkbhw_base` macro is a template to allow the use of identical
...
#define LAYOUT_ffkbhw_base( \
  ...
  LAYOUT_wrapper( \
        ...
        K21,             K22,            K23,            K24,                K25,              K26,                K27,                K28,              K29,            K2A, \
                         KC_MUTE,        K33,            LT(_NAVIGATION,K34), LT(_FUNCTION,K35), LT(_MEDIA,K36),   LT(_SYMBOLS,K37),   K38,              LCTL(KC_DEL) \
    )

/* Re-pass though to allow templates to be used */
#define LAYOUT_ffkbhw_base_wrapper(...)       LAYOUT_ffkbhw_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_ffkbhw_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_ffkbhw_base_wrapper(
