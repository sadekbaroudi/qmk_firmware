...
/*
 * The `LAYOUT_testamatta_base` macro is a template to allow the use of identical
...
#define LAYOUT_testamatta_base( \
  ...
  LAYOUT_wrapper( \
        ...
        KC_MUTE,         KC_VOLD,        KC_VOLU,        K33,            LT(_NAVIGATION,K34),    LT(_FUNCTION,K35),        LT(_MEDIA,K36),        LT(_SYMBOLS,K37),      K38,              KC_VOLD,        KC_VOLU,      KC_MUTE  \
    )

/* Re-pass though to allow templates to be used */
#define LAYOUT_testamatta_base_wrapper(...)       LAYOUT_testamatta_base(__VA_ARGS__)

const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {

    [_ALPHA_ALT] = LAYOUT_testamatta_base_wrapper(
    ...
    [_ALPHA] = LAYOUT_testamatta_base_wrapper(
    ...
    [_FUNCTION] = LAYOUT_wrapper(
        ...
        _______, _______, _______, _______, _______, _______, N_DEL_LINE, KC_SPACE, _______, _______, _______, _______
    ),
