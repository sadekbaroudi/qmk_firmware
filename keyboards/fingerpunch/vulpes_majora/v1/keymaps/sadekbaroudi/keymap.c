...
#define LAYOUT_vulpes_majora_base( \
  ...
  LAYOUT_wrapper( \
        ...
        MS_BTN2,      K21,            K22,            K23,            K24,                    K25,                                                                       K26,                   K27,                   K28,              K29,            K2A,          FP_SNIPE_TOG,  \
                                                         K33,            LT(_NAVIGATION,K34),    LT(_FUNCTION,K35),          MS_BTN3, MS_BTN1, MS_BTN2,            LT(_MEDIA,K36),        LT(_SYMBOLS,K37),      K38,                                                           \
                         KC_VOLU,                        MS_BTN3,     MS_BTN1,             MS_BTN2,                                                                KC_VOLD,               KC_MUTE,               KC_VOLU,                          KC_VOLU,                     \
