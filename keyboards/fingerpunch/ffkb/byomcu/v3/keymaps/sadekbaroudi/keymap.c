...
#define LAYOUT_ffkb_base( \
  ...
  LAYOUT_wrapper( \
        ...
        MS_BTN1,      LCTL_T(K11),    LGUI_T(K12),    LALT_T(K13),    LSFT_T(K14),            K15,                      LT(_MOUSE, K16),       RSFT_T(K17),           RALT_T(K18),      RGUI_T(K19),    RCTL_T(K1A),  FP_SNIPE_TOG, \
        MS_BTN2,      K21,            K22,            K23,            K24,                    K25,                      K26,                   K27,                   K28,              K29,            K2A,          FP_ZOOM_TOG, \
